...
extern choreo::spanned_data<choreo::f32, 2> kernel_6f75e5bf(const choreo::spanned_view<choreo::f32, 2>& input_0, const choreo::spanned_view<choreo::f32, 2>& input_1);
...
extern "C" {
    int execute_kernel(void* input_data_0, size_t* input_shape_0, void* input_data_1, size_t* input_shape_1, void* output_data, size_t* output_shape) {
        try {
            ...
            auto result = kernel_6f75e5bf(input_0_view, input_1_view);
