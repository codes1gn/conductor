...
class ChoreoJITCompiler:
    ...
    def compile_graph(
        ...
        try:
            ...
            compilation_dsl_debug_path = debug_manager.save_compilation_dsl_source(
                function_name, dsl_file_path
            )
    ...
    def invoke_choreo_compiler(self, dsl_file_path: str, kernel_name: str = "unknown") -> str:
        ...
        try:
            ...
            if link_result.returncode != 0:
                ...
                raise CompilationError(
                    error_msg, dsl_code="", compiler_output=link_result.stderr or link_result.stdout
                )
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_size_bytes": sum(
                entry.get("size_bytes", 0) for entry in self._cache._metadata.values()
            ),
