...
class ExecutionError(ConductorError):
    ...
    def __init__(
        self, message: str, kernel_name: Optional[str] = None, exit_code: Optional[int] = None
    ):
        """
...
class FallbackHandler:
    ...
    def execute_fallback(self, graph_module: torch.fx.GraphModule, reason: str = "") -> Callable:
        ...
        try:
            ...
            assert False, f"torch.compile not available: {e}"
    ...
    def get_fallback_stats(self) -> dict:
        ...
        return {
            ...
            "most_common_reason": (
                max(self._fallback_reasons.items(), key=lambda x: x[1])[0]
