...
class TopsccEnvironment:
    ...
    def get_link_command(self, object_files: List[str], output_path: str, 
                        shared: bool = True, extra_flags: Optional[List[str]] = None) -> List[str]:
        """
    ...
    def get_compile_command(self, source_files: List[str], output_path: str,
                           include_dirs: Optional[List[str]] = None,
                           extra_flags: Optional[List[str]] = None,
                           host_code: bool = True) -> List[str]:
        """
...
def compile_with_topscc(source_files: List[str], output_path: str,
                       include_dirs: Optional[List[str]] = None,
                       extra_flags: Optional[List[str]] = None,
                       timeout: int = 60, host_code: bool = True) -> Tuple[bool, str]:
    """
    ...
    try:
        cmd = topscc_env.get_compile_command(source_files, output_path, include_dirs, extra_flags, host_code)
...
def link_with_topscc(object_files: List[str], output_path: str,
                    shared: bool = True, extra_flags: Optional[List[str]] = None,
