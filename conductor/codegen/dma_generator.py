...
class DMAGenerator:
    ...
    def generate_load_sequence(self, 
                             source_vars: list[str], 
                             target_vars: list[str],
                             parallel_var: str,
                             index_var: str,
                             pattern_name: str = "global_to_l1_async") -> list[str]:
        """
    ...
    def generate_store_sequence(self,
                              source_vars: list[str],
                              target_vars: list[str], 
                              parallel_var: str,
                              index_var: str,
                              pattern_name: str = "l1_to_global") -> list[str]:
        """
    ...
    def generate_buffer_declaration(self, 
                                  var_name: str,
                                  dtype: str,
    ...
    def generate_parallel_loop(self,
                             parallel_var: str,
                             parallel_factor: int,
                             index_var: str,
                             chunk_size: int,
