...
class ConductorNode:
    ...
    def can_fuse_with(self, other: 'ConductorNode') -> bool:
        ...
        # Both operations must be elementwise to fuse
        if (self.op_name in elementwise_ops and 
            other.op_name in elementwise_ops):
            return self._check_shape_compatibility(other)
        
        # Elementwise followed by reduction can fuse
        if (self.op_name in elementwise_ops and 
            other.op_name in reduction_ops):
